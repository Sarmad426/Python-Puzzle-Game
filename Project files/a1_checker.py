...
assert isinstance(got, str), type_error_message(
    "puzzle_functions.get_current_player", "str", type(got)
)
...
assert isinstance(got, str), type_error_message(
    "puzzle_functions.get_winner", "str", type(got)
)
print("  check complete")
...
assert isinstance(got, int), type_error_message(
    "puzzle_functions.get_factor", "int", type(got)
)
print("  check complete")
...
assert isinstance(got, str), type_error_message(
    "puzzle_functions.reverse", "str", type(got)
)
print("  check complete")
...
got = pf.get_row("abcd\nefgh\nijkl\n", 1)
assert isinstance(got, str), type_error_message(
    "puzzle_functions.get_row", "str", type(got)
)
print("  check complete")
...
assert isinstance(got, int), type_error_message(
    "puzzle_functions.get_points", "int", type(got)
)
print("  check complete")
...
assert isinstance(got, int), type_error_message(
    "puzzle_functions.check_guess", "int", type(got)
)
print("  check complete")
